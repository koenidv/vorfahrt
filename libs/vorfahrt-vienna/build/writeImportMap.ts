...
export function getIndexFile(sprites: WrittenSprite[]) {
    ...
    declarationFile += "export default findIcon as " + findIconType + ";\n"
    declarationFile += "}\n\n";
    declarationFile += "export enum fileTypes { " + [...fileTypes].map(el => `${el} = "${el}"`).join(", ") + " };\n";
...
const findIconType = "(filetype: fileTypes, entities: (typeof entityTags)[]) => string | undefined;"
