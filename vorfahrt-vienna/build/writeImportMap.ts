...
export function getIndexFile(sprites: WrittenSprite[]) {
    ...
    declarationFile += "declare const fileTypes: { " + [...fileTypes].map(el => `${el}: "${el}"`).join(", ") + " };\n";
    declarationFile += "declare const entityTypes: " + [...entityTypes].map(e => `"${e}"`).join(" | ") + ";\n";
    declarationFile += "declare const findIcon: " + findIconType + "\n\n";
...
const findIconType = "(filetype: keyof typeof fileTypes, entities: (typeof entityTypes)[]) => string | undefined;"
