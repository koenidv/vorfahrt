...
export function applyMilesMapScrapingFilters(city: MilesCityAreaBounds, mapSearch: MilesAreaSearch) {
...
function applyFuelFilters(city: MilesCityAreaBounds, mapSearch: MilesAreaSearch) {
